<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CNTWEN.aspx.cs" Inherits="Language.Web.Web.CNTWEN" %>
     ...
     <div id="round">
        <div class="rtop">
            ...
            <div id="topbar" class="r4">
                当前位置：&nbsp;&nbsp;<a href="../Web/CNTWEN.aspx" target="_self" class="lastA" >中英文翻译</a>
            </div>
        </div>
        <div>
            <table id="taskShow" class="Show">
                <thead>
                    ...
                    <tr>
                        ...
                        <td style="text-align:center;">词条内容</td>
    ...
    <div>
        <fieldset class="FieldSet">
            ...
            <table>
                ...
                <tr>
                    <td style="text-align:right;">中文简体翻译：</td>
                    <td>
                      <textarea id="txtWordCN"  name="txtWordCN" cols="20" rows="2"
                             style="width:500px; min-height:30px;font-size:9pt;" ></textarea>
                    </td>
                </tr>
                <tr>
                    <td style="text-align:right;">中文繁体翻译：</td>
                    <td>
                        <textarea id="txtWordTW"  name="txtWordTW" cols="20" rows="2"
                             style="width:500px; min-height:30px;font-size:9pt;" ></textarea>
                    </td>
                </tr>
                 <tr>
                    <td style="text-align:right;">英文翻译：</td>
                    <td>
